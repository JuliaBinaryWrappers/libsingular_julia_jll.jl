# `libsingular_julia_jll.jl` (v0.28.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/bd1baf0e2a0bd9c6686efac2ffbcf7b5165f32be/L/libsingular_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oscar-system/libsingular-julia.git (revision: `1d0faf13a6edfea40a084df9bdd47b585973679d`)
