# `libsingular_julia_jll.jl` (v0.47.4+1)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/e6b3821cebe096b8aee61a336d5ed21b838e8e95/L/libsingular_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oscar-system/Singular.jl.git (revision: `3eb3e2d8cddd0d68cf9266bddde8048809b2a6be`)
