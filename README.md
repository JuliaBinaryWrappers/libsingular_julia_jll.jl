# `libsingular_julia_jll.jl` (v0.45.1+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/4fc1febc4083e6ca4db27d18421b651bb0119e00/L/libsingular_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oscar-system/Singular.jl.git (revision: `dd0d827275417ae24841f82859e8b797183342c6`)
