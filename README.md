# `libsingular_julia_jll.jl` (v0.45.5+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/cfdff94d608c9251c44be01aa722eefafd0232c2/L/libsingular_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oscar-system/Singular.jl.git (revision: `77d09431c791b40375bd3f2acd76f7232b30773b`)
