# `libsingular_julia_jll.jl` (v0.22.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/75717084886555990175c2bc3b9b7e0ba0fd94c4/L/libsingular_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.")
...
* git repository: https://github.com/oscar-system/libsingular-julia.git (revision: `ca249677b8e3e1cb15515869798855fe190c5696`)
