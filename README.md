# `libsingular_julia_jll.jl` (v0.45.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/53bee68d9dc9efcd0c3f24bac2bf749aa881c6a8/L/libsingular_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oscar-system/Singular.jl.git (revision: `91dfa8ddf0ba85b735401ee84a62448bcf4d200f`)
