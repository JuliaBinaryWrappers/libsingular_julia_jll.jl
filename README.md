# `libsingular_julia_jll.jl` (v0.29.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/c94ef4063f2a04b332a4a1a0b364076015cffcb7/L/libsingular_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oscar-system/libsingular-julia.git (revision: `c19d4c5b69e1fbb3b7b2f2f72dc254cfbf9fa3e6`)
