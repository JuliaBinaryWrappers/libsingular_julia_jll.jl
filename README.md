# `libsingular_julia_jll.jl` (v0.27.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/f5d54203be857d22c7a95a6d4d00e7c17a82f3a7/L/libsingular_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oscar-system/libsingular-julia.git (revision: `745ec632511cae7e4c054d254ac24d1043ec8a32`)
