# `libsingular_julia_jll.jl` (v0.40.6+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/0cd7dfc2419306488311dc11b7ce40b5f20c3da9/L/libsingular_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oscar-system/Singular.jl.git (revision: `6304657a72cace556fc8dfb0577a91f92b491e63`)
